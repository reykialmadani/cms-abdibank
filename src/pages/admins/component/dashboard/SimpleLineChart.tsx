//src/pages/admins/component/dashboard/SimpleLineChart.tsx
...
const SimpleLineChart: React.FC = () => {
  ...
  const handleViewModeChange = (mode: 'total' | 'unique') => {
    setViewMode(mode);
  };
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-md">
      ...
      {/* Toggle untuk melihat total visit atau unique visitors */}
      <div className="mb-4">
